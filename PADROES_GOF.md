...
| # | Padrão                  | Categoria      | Arquivo principal                                             |
|---|-------------------------|----------------|---------------------------------------------------------------|
| 1 | Factory Method          | Criacional     | `patterns/factory.py`                                        |
| 2 | Prototype               | Criacional     | `models/note.py`                                             |
| 3 | Adapter                 | Estrutural     | `utils/logger_adapter.py`                                    |
| 4 | Bridge                  | Estrutural     | `repository/`, `repository/strategies.py`                    |
| 5 | Chain of Responsibility | Comportamental | `patterns/chain.py`                                          |
| 6 | Command                 | Comportamental | `patterns/command.py`, `patterns/sender.py`                  |
| 7 | Memento                 | Comportamental | `patterns/memento.py`                                        |
| 8 | Observer                | Comportamental | `patterns/observer.py`                                       |
| 9 | Strategy                | Comportamental | `repository/strategies.py`, `interface/interface_strategy.py`|
|10 | Template Method         | Comportamental | `patterns/export.py`                                         |
